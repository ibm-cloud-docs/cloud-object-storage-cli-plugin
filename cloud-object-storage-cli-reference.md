...
## Prerequisites
{: #ic-cos-prerequisites}
* An [{{site.data.keyword.cloud}}](https://cloud.ibm.com/) account
* An instance of [{{site.data.keyword.cos_full}}](/docs/services/cloud-object-storage/basics?topic=cloud-object-storage-gs-dev#gs-dev-provision)
* The [{{site.data.keyword.cloud}} CLI](https://cloud.ibm.com/docs/cli?topic=cloud-cli-ibmcloud_cli)
...
You can view your current {{site.data.keyword.cos_full}} credentials by prompting `ibmcloud cos config list`. As the config file is generated by the plug-in, it's best not to edit the file manually.

### IAM Authentication
{: #ic-cos-IAM-authentication}
...
## Command index
{: #ic-cos-command-index}

| Commands |  |  |
| --- | --- | --- |
| [`abort-multipart-upload`](#ic-cos-abort-multipart-upload) | [`complete-multipart-upload`](#ic-cos-complete-multipart-upload) | [`config`](#ic-cos-config) |
| [`copy-object`](#ic-cos-copy-object) | [`create-bucket`](#ic-cos-create-bucket) | [`create-multipart-upload`](#ic-cos-create-multipart-upload) |
| [`delete-bucket`](#ic-cos-delete-bucket) | [`delete-bucket-cors`](#ic-cos-delete-bucket-cors) | [`delete-object`](#ic-cos-delete-object) |
| [`delete-objects`](#ic-cos-delete-objects) | [`download`](#ic-cos-download-s3manager) | [`get-bucket-class`](#ic-cos-bucket-class) | 
| [`get-bucket-cors`](#ic-cos-get-bucket-cors) | [`get-bucket-location`](#ic-cos-find-bucket) | [`get-object`](#ic-cos-download-object) |
| [`head-bucket`](#ic-cos-bucket-header) | [`head-object`](#ic-cos-object-header) | [`list-buckets`](#ic-cos-list-buckets) | 
| [`list-buckets-extended`](#ic-cos-extended-bucket-listing) | [`list-multipart-uploads`](#ic-cos-list-multipart-uploads) | [`list-objects`](#ic-cos-list-objects) |
| [`list-parts`](#ic-cos-list-parts) | [`put-bucket-cors`](#ic-cos-set-bucket-cors) | [`put-object`](#ic-cos-upload-object) |
| [`upload`](#ic-cos-upload-s3manager) | [`upload-part`](#ic-cos-upload-part) | [`upload-part-copy`](#ic-cos-upload-a-part-copy) |
| [`wait`](#ic-cos-wait) |  |  |
...
{: #ic-cos-complete-multipart-upload}
...
{: #ic-cos-manual-multipart-uploads}

The {{site.data.keyword.cloud}} Object Storage CLI provides the ability for users to upload large files in multiple parts by using the multipart upload functions. To initiate a new multipart upload, run the `create-multipart-upload` command, which returns the new upload instance's upload ID. 

To continue with the upload process, you must save the upload ID for each subsequent command.
{:tip}
...
{: #ic-cos-create-multipart-upload}
...
{: #ic-cos-extended-bucket-listing}
* **Action:** Print a list of all the buckets in a user's IBM Cloud Object Storage account. Buckets might be located in different regions.
