...
You can turn off sophisticated troubleshooting tools by running `ibmcloud config --trace false` or by adding the statement `export IBMCLOUD_TRACE=false` to your environment variables or application build process. This will improve performance at the expense of inspecting transactions.
{: tip}
